        ...
        <div className="text-black flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-3">
            <button className="hidden sm:flex flex-col items-center text-white/80 hover:text-white transition-colors">
              ...
              <span className="text-[#050505] mt-0.5 text-sm font-normal capitalize">{t(lang, 'nav_saved')}</span>
            </button>
            <button className="hidden sm:flex flex-col items-center text-white/80 hover:text-white transition-colors">
              <User className="text-[hsl(var(--foreground))] lucide lucide-user w-5 h-5" />
              <span className="bg-[hsl(var(--sidebar-primary))] text-[hsl(var(--foreground))] mt-0.5 text-sm font-normal">{t(lang, 'nav_sign_in')}</span>
            </button>
            {/* Language switcher */}
