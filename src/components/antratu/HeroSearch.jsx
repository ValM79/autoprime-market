...
const prices = [0,100,300,500,1000,1500,2000,2500,3000,3500,4000,4500,5000,6000,7000,8000,9000,10000,11000,12000,13000,14000,15000,17500,20000,22500,25000,27500,30000,35000,40000,45000,50000,60000,70000,80000,90000,100000,110000,120000].map(p => p === 0 ? '€0' : `€${p.toLocaleString()}`);
      ...
      <div className="relative max-w-7xl mx-auto px-4 py-10 md:py-16 lg:py-20">
        <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-8">
          <div className="bg-white rounded-xl shadow-2xl p-6 md:p-8 w-full max-w-md">
            <h1 className="text-foreground mb-5 text-xs font-normal underline normal-case md:text-2xl">Cars & Motor
